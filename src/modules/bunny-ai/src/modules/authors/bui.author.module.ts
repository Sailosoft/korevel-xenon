...
export const buiAuthorModule: BunnyConfig<BUIAuthor, BUIAuthor> = {
  ...
  query: {
    getAll: async function (_options: AdminPanelQueryOptions, _overrideOptions?: AdminPanelQueryOptions): Promise<GetAllResponse<BUIAuthor>> {
      return adminPanelQueryResponseAll({
        data: await buiDatabase.authors.toArray(),
      });
    },
    getOne: async function (id: string | number): Promise<BUIAuthor | undefined> {
      return await buiDatabase.authors.get(Number(id));
    }
  },
  mutation: {
    create: async function (data: BUIAuthor): Promise<AdminPanelResult<BUIAuthor, unknown>> {
    ...
    update: async function (id: AdminPanelId, data: BUIAuthor): Promise<AdminPanelResult<BUIAuthor, unknown> | undefined> {
      if (typeof id !== 'number') {
    ...
    delete: async function (iid: AdminPanelId): Promise<AdminPanelResult<BUIAuthor, unknown> | undefined> {
      const id = Number(iid);
